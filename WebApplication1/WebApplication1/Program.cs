...
using WebApplication1.Data.Repository.Repositories;
...
builder.Services.AddDbContext<MusicDbContext>(o => o.UseSqlServer(builder.Configuration.GetConnectionString("DefaultConnection")));
